...
1) How can **landscape and reach-scale characteristics** explain **spatial variation in thermal sensitivity** of streams within a Cascades river basin **during an anomalously warm summer**?
...
# Code Structure
1) **Regularized regression:** ridge, LASSO, elastic net techniques to provide predictor stability from predictors identified by MLR variable selection procedure. 
